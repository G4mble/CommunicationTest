...
public class Level_Ready {
	...
	private void placeDoorsBoss(int actID, int levelID, Tile[][] map) {
		if (actID == 1) {
			map[7][1] = new SW_Door_2();
			map[7][18] = new SW_Door_3();
			map[14][10] = new SW_Door_4();
		}
		if (actID == 2) {
			map[7][1] = new RW_Door_2();
			map[7][18] = new RW_Door_3();
			map[14][10] = new RW_Door_4();
		}
		if (actID == 3) {
			map[7][1] = new UW_Door_2();
			map[7][18] = new UW_Door_3();
			map[14][10] = new UW_Door_4();
		}
	}
	...
	private void placeDoorsShop(int actID, int levelID, Tile[][] map) {
		if (actID == 1) {
			if (levelID == 4 || levelID == 6) {
				map[1][6] = new SW_Door_1();
				map[10][4] = new SW_Door_5();
				map[10][8] = new SW_Door_6();
			}
			if (levelID == 17 || levelID == 19) {
				map[1][4] = new SW_Door_2();
				map[1][8] = new SW_Door_3();
				map[10][6] = new SW_Door_4();
			}
		}
		if (actID == 2) {
			if (levelID % 22 == 4 || levelID % 22 == 6) {
				map[1][6] = new RW_Door_1();
				map[10][4] = new RW_Door_5();
				map[10][8] = new RW_Door_6();
			}
			if (levelID % 22 == 17 || levelID % 22 == 19) {
				map[1][4] = new RW_Door_2();
				map[1][8] = new RW_Door_3();
				map[10][6] = new RW_Door_4();
			}
		}
		if (actID == 3) {
			if (levelID % 44 == 4 || levelID % 44 == 6) {
				map[1][6] = new UW_Door_1();
				map[10][4] = new UW_Door_5();
				map[10][8] = new UW_Door_6();
			}
			if (levelID % 44 == 17 || levelID % 44 == 19) {
				map[1][4] = new UW_Door_2();
				map[1][8] = new UW_Door_3();
				map[10][6] = new UW_Door_4();
			}
		}
	}
	...
	public Tile[][] createStartLevel() {
		...
		ob.getLevel()[0][2] = new SW_Door_1();
		/* Place the exit door */
		ob.getLevel()[4][2] = new SW_Door_4();
