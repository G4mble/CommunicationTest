...
public abstract class EquipmentModel extends ItemModel
{
	 ...
	 * @author Staufenberg, Thomas, 5820359
	 * */
	public boolean equip(PlayerCharacter paramPlayer, int paramInventoryPosition)
	{
		return paramPlayer.getInventory().equipItem(this, paramInventoryPosition);
	}
	 ...
	 * @author Staufenberg, Thomas, 5820359
	 * */
	protected boolean removeFromEquip(PlayerCharacter paramPlayer, boolean paramAddToInventory, int paramInventoryPosition)
	{
		return paramPlayer.getInventory().removeItemFromEquip(this, paramAddToInventory, paramInventoryPosition);
	}
